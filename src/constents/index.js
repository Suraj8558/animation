...
export const myProjects = [
  ...
  {
    title: "AirDNA - Unlock the Power of Data for Short-Term Rentals",
    desc: "AirDNA provides comprehensive data and analytics for short-term rental markets, helping property owners and investors make informed decisions.",
    subdesc:
      "With insights from millions of rental listings, AirDNA empowers users to optimize their rental strategies and maximize revenue. Discover market trends and performance metrics with ease.",
